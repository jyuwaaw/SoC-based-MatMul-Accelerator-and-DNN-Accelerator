...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln24_6 \
    op interface \
    ports { sext_ln24_6 { I 62 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sum_11_out \
    op interface \
    ports { sum_11_out { O 32 vector } sum_11_out_ap_vld { O 1 bit } } \
} "
}
...
set InstName convolution5_hls_flow_control_loop_pipe_sequential_init_U
set CompName convolution5_hls_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix convolution5_hls_ \
}"
} else {
