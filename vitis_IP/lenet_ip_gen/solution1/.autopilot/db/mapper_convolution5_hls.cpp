...
using hls::sim::Byte;
extern "C" void convolution5_hls(Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, int, int, int, int);
extern "C" void apatb_convolution5_hls_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_weights, volatile void * __xlx_apatb_param_bias, volatile void * __xlx_apatb_param_output_r) {
...
__xlx_input_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_input_r)[i]);
  ...
  int __xlx_size_param_input_r = 400;
...
__xlx_weights__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_weights)[i]);
  ...
  int __xlx_size_param_weights = 48000;
...
__xlx_output_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_output_r)[i]);
  ...
  int __xlx_size_param_output_r = 120;
  int __xlx_offset_param_output_r = 0;
  int __xlx_offset_byte_param_output_r = 0*4;
  // DUT call
  convolution5_hls(__xlx_input_r__tmp_vec.data(), __xlx_weights__tmp_vec.data(), __xlx_bias__tmp_vec.data(), __xlx_output_r__tmp_vec.data(), __xlx_offset_byte_param_input_r, __xlx_offset_byte_param_weights, __xlx_offset_byte_param_bias, __xlx_offset_byte_param_output_r);
