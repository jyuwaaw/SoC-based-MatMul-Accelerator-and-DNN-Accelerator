# 1 "../SoC-based-MatMul-Accelerator-and-DNN-Accelerator/lenet_hls/lenet_conv5_hls.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../SoC-based-MatMul-Accelerator-and-DNN-Accelerator/lenet_hls/lenet_conv5_hls.cpp" 2
...
# 3 "../SoC-based-MatMul-Accelerator-and-DNN-Accelerator/lenet_hls/lenet_conv5_hls.cpp" 2
...
# 4 "../SoC-based-MatMul-Accelerator-and-DNN-Accelerator/lenet_hls/lenet_conv5_hls.cpp" 2

__attribute__((sdx_kernel("convolution5_hls", 0))) void convolution5_hls(
    float input[16][5][5],
    float weights[120][16][5][5],
    float bias[120],
    float output[120][1][1]
) {
#line 15 "E:/Vitis/lenet_ip_gen/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=convolution5_hls
# 10 "../SoC-based-MatMul-Accelerator-and-DNN-Accelerator/lenet_hls/lenet_conv5_hls.cpp"
...
#pragma HLS INTERFACE m_axi depth=120 port=output offset=slave bundle=OUTPUT
 ...
 VITIS_LOOP_18_1: for (int co = 0; co < 120; co++) {
#pragma HLS UNROLL factor=8

 float sum = 0.0f;


        VITIS_LOOP_24_2: for (int ci = 0; ci < 16; ci++) {
            VITIS_LOOP_25_3: for (int kh = 0; kh < 5; kh++) {
                VITIS_LOOP_26_4: for (int kw = 0; kw < 5; kw++) {
