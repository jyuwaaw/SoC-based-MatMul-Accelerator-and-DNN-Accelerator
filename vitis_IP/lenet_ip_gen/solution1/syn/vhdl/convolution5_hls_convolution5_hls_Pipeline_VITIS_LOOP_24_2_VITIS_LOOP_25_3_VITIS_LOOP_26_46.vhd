...
entity convolution5_hls_convolution5_hls_Pipeline_VITIS_LOOP_24_2_VITIS_LOOP_25_3_VITIS_LOOP_26_46 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of convolution5_hls_convolution5_hls_Pipeline_VITIS_LOOP_24_2_VITIS_LOOP_25_3_VITIS_LOOP_26_46 is 
...
attribute shreg_extract : string;
    ...
    signal mul_6_reg_225 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal indvar_flatten160_fu_64 : STD_LOGIC_VECTOR (8 downto 0) := "000000000";
    signal add_ln24_fu_132_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_sig_allocacmp_indvar_flatten160_load : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    indvar_flatten160_fu_64_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln24_fu_126_p2 = ap_const_lv1_0))) then 
                    indvar_flatten160_fu_64 <= add_ln24_fu_132_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    indvar_flatten160_fu_64 <= ap_const_lv9_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                ...
                mul_6_reg_225 <= grp_fu_1945_p_dout0;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln24_fu_132_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten160_load) + unsigned(ap_const_lv9_1));
    ...
    ap_sig_allocacmp_indvar_flatten160_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_loop_init, indvar_flatten160_fu_64, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_indvar_flatten160_load <= ap_const_lv9_0;
        else 
            ap_sig_allocacmp_indvar_flatten160_load <= indvar_flatten160_fu_64;
        end if; 
    end process;


    ap_sig_allocacmp_sum_load_2_assign_proc : process(ap_enable_reg_pp0_iter2, ap_CS_fsm_pp0_stage2, sum_fu_60, ap_block_pp0_stage2, grp_fu_1949_p_dout0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
            ap_sig_allocacmp_sum_load_2 <= grp_fu_1949_p_dout0;
        else 
            ap_sig_allocacmp_sum_load_2 <= sum_fu_60;
        end if; 
    end process;
    ...
    grp_fu_1949_p_din0 <= ap_sig_allocacmp_sum_load_2;
    grp_fu_1949_p_din1 <= mul_6_reg_225;
    ...
    icmp_ln24_fu_126_p2 <= "1" when (ap_sig_allocacmp_indvar_flatten160_load = ap_const_lv9_190) else "0";
    ...
    sum_13_out <= sum_fu_60;

    sum_13_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage2, icmp_ln24_reg_201_pp0_iter1_reg, ap_block_pp0_stage2_11001)
    begin
