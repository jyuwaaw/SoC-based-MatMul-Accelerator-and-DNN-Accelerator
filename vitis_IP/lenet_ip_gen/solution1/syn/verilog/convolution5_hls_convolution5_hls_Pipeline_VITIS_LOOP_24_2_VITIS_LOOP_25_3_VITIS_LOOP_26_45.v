...
module convolution5_hls_convolution5_hls_Pipeline_VITIS_LOOP_24_2_VITIS_LOOP_25_3_VITIS_LOOP_26_45 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [31:0] mul_5_reg_225;
reg    ap_enable_reg_pp0_iter0_reg;
reg   [31:0] sum_fu_60;
reg   [31:0] ap_sig_allocacmp_sum_load_3;
wire    ap_block_pp0_stage2;
wire    ap_loop_init;
reg   [8:0] indvar_flatten140_fu_64;
wire   [8:0] add_ln24_fu_132_p2;
reg   [8:0] ap_sig_allocacmp_indvar_flatten140_load;
...
#0 sum_fu_60 = 32'd0;
#0 indvar_flatten140_fu_64 = 9'd0;
#0 ap_done_reg = 1'b0;
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_loop_init == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_sig_allocacmp_indvar_flatten140_load = 9'd0;
    end else begin
...
assign add_ln24_fu_132_p2 = (ap_sig_allocacmp_indvar_flatten140_load + 9'd1);
...
assign grp_fu_1949_p_din0 = ap_sig_allocacmp_sum_load_3;

assign grp_fu_1949_p_din1 = mul_5_reg_225;

assign grp_fu_1949_p_opcode = 2'd0;

assign icmp_ln24_fu_126_p2 = ((ap_sig_allocacmp_indvar_flatten140_load == 9'd400) ? 1'b1 : 1'b0);
...
assign sum_11_out = sum_fu_60;

assign weight_val_fu_159_p1 = WEIGHTS_addr_read_reg_210;

endmodule //convolution5_hls_convolution5_hls_Pipeline_VITIS_LOOP_24_2_VITIS_LOOP_25_3_VITIS_LOOP_26_45
