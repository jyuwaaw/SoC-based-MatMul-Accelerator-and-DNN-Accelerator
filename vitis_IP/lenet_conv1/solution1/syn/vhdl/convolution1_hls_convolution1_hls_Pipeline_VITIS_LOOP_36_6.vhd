...
entity convolution1_hls_convolution1_hls_Pipeline_VITIS_LOOP_36_6 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of convolution1_hls_convolution1_hls_Pipeline_VITIS_LOOP_36_6 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln36_fu_90_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal co_1_reg_133 : STD_LOGIC_VECTOR (2 downto 0);
    signal co_1_reg_133_pp0_iter1_reg : STD_LOGIC_VECTOR (2 downto 0);
    signal BIAS_addr_read_reg_142 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln36_fu_113_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal co_fu_50 : STD_LOGIC_VECTOR (2 downto 0) := "000";
    signal add_ln36_fu_96_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_co_1 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    ...
    co_fu_50_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln36_fu_90_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    co_fu_50 <= add_ln36_fu_96_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    co_fu_50 <= ap_const_lv3_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                BIAS_addr_read_reg_142 <= m_axi_BIAS_RDATA;
                ap_loop_exit_ready_pp0_iter1_reg <= ap_loop_exit_ready;
                co_1_reg_133 <= ap_sig_allocacmp_co_1;
                co_1_reg_133_pp0_iter1_reg <= co_1_reg_133;
            end if;
        end if;
    end process;
    ...
    BIAS_blk_n_R_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, m_axi_BIAS_RVALID, ap_block_pp0_stage0)
    begin
    ...
    add_ln36_fu_96_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_co_1) + unsigned(ap_const_lv3_1));
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(m_axi_BIAS_RVALID)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (m_axi_BIAS_RVALID = ap_const_logic_0);
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln36_fu_90_p2)
    begin
        if (((icmp_ln36_fu_90_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_co_1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, co_fu_50, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_co_1 <= ap_const_lv3_0;
        else 
            ap_sig_allocacmp_co_1 <= co_fu_50;
        end if; 
    end process;

    icmp_ln36_fu_90_p2 <= "1" when (ap_sig_allocacmp_co_1 = ap_const_lv3_6) else "0";
    local_bias_address0 <= zext_ln36_fu_113_p1(3 - 1 downto 0);

    local_bias_ce0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
    ...
    local_bias_d0 <= BIAS_addr_read_reg_142;

    local_bias_we0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            local_bias_we0 <= ap_const_logic_1;
        else 
            local_bias_we0 <= ap_const_logic_0;
        end if; 
    end process;

    m_axi_BIAS_ARADDR <= ap_const_lv64_0;
    m_axi_BIAS_ARBURST <= ap_const_lv2_0;
    m_axi_BIAS_ARCACHE <= ap_const_lv4_0;
    m_axi_BIAS_ARID <= ap_const_lv1_0;
    m_axi_BIAS_ARLEN <= ap_const_lv32_0;
    ...
    m_axi_BIAS_AWADDR <= ap_const_lv64_0;
    ...
    zext_ln36_fu_113_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(co_1_reg_133_pp0_iter1_reg),64));
end behav;
