...
module convolution1_hls_convolution1_hls_Pipeline_VITIS_LOOP_36_6 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [2:0] local_bias_address0;
...
reg   [2:0] co_1_reg_133;
reg   [2:0] co_1_reg_133_pp0_iter1_reg;
reg   [31:0] BIAS_addr_read_reg_142;
wire   [63:0] zext_ln36_fu_113_p1;
reg   [2:0] co_fu_50;
wire   [2:0] add_ln36_fu_96_p2;
wire    ap_loop_init;
reg   [2:0] ap_sig_allocacmp_co_1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln36_fu_90_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln36_fu_90_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln36_fu_96_p2 = (ap_sig_allocacmp_co_1 + 3'd1);
...
assign icmp_ln36_fu_90_p2 = ((ap_sig_allocacmp_co_1 == 3'd6) ? 1'b1 : 1'b0);

assign local_bias_address0 = zext_ln36_fu_113_p1;

assign local_bias_d0 = BIAS_addr_read_reg_142;
...
assign zext_ln36_fu_113_p1 = co_1_reg_133_pp0_iter1_reg;

endmodule //convolution1_hls_convolution1_hls_Pipeline_VITIS_LOOP_36_6
