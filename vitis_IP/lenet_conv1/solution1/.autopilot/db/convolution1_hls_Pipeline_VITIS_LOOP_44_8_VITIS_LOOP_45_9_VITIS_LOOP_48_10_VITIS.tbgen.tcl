set moduleName convolution1_hls_Pipeline_VITIS_LOOP_44_8_VITIS_LOOP_45_9_VITIS_LOOP_48_10_VITIS
set isTopModule 0
...
set C_modelName {convolution1_hls_Pipeline_VITIS_LOOP_44_8_VITIS_LOOP_45_9_VITIS_LOOP_48_10_VITIS}
set C_modelType { void 0 }
set C_modelArgList {
	{ OUTPUT_r int 32 regular {axi_master 1}  }
	{ sext_ln44_1 int 62 regular  }
	{ add_ln51_2 int 6 regular  }
	{ local_weights float 32 regular {array 150 { 1 3 } 1 1 }  }
	{ local_input float 32 regular {array 1024 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "OUTPUT_r", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "output_r","offset": { "type": "dynamic","port_name": "output_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln44_1", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
 	{ "Name" : "add_ln51_2", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln44_1 sc_in sc_lv 62 signal 1 } 
	{ add_ln51_2 sc_in sc_lv 6 signal 2 } 
	{ local_weights_address0 sc_out sc_lv 8 signal 3 } 
	{ local_weights_ce0 sc_out sc_logic 1 signal 3 } 
	{ local_weights_q0 sc_in sc_lv 32 signal 3 } 
	{ local_input_address0 sc_out sc_lv 10 signal 4 } 
	{ local_input_ce0 sc_out sc_logic 1 signal 4 } 
	{ local_input_q0 sc_in sc_lv 32 signal 4 } 
	{ local_bias_load_1 sc_in sc_lv 32 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln44_1", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln44_1", "role": "default" }} , 
 	{ "name": "add_ln51_2", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "add_ln51_2", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "58812", "Max" : "58812"}
	, {"Name" : "Interval", "Min" : "58812", "Max" : "58812"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln44_1 { ap_none {  { sext_ln44_1 in_data 0 62 } } }
	add_ln51_2 { ap_none {  { add_ln51_2 in_data 0 6 } } }
	local_weights { ap_memory {  { local_weights_address0 mem_address 1 8 }  { local_weights_ce0 mem_ce 1 1 }  { local_weights_q0 mem_dout 0 32 } } }
	local_input { ap_memory {  { local_input_address0 mem_address 1 10 }  { local_input_ce0 mem_ce 1 1 }  { local_input_q0 mem_dout 0 32 } } }
