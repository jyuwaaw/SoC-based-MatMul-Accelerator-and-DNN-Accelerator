set moduleName convolution1_hls_Pipeline_VITIS_LOOP_36_6
set isTopModule 0
...
set C_modelName {convolution1_hls_Pipeline_VITIS_LOOP_36_6}
set C_modelType { void 0 }
set C_modelArgList {
	{ BIAS int 32 regular {axi_master 0}  }
	{ sext_ln36 int 62 regular  }
	{ local_bias float 32 regular {array 6 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ local_bias_address0 sc_out sc_lv 3 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "local_bias_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "local_bias", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	...
	local_bias { ap_memory {  { local_bias_address0 mem_address 1 3 }  { local_bias_ce0 mem_ce 1 1 }  { local_bias_we0 mem_we 1 1 }  { local_bias_d0 mem_din 1 32 } } }
}
