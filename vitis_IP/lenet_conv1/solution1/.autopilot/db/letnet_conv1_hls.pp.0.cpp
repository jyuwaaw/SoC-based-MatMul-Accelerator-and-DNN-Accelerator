# 1 "../Xilinx_Prj/SoC-based-MatMul-Accelerator-and-DNN-Accelerator/letnet_hls/letnet_conv1_hls.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../Xilinx_Prj/SoC-based-MatMul-Accelerator-and-DNN-Accelerator/letnet_hls/letnet_conv1_hls.cpp" 2
...
# 3 "../Xilinx_Prj/SoC-based-MatMul-Accelerator-and-DNN-Accelerator/letnet_hls/letnet_conv1_hls.cpp" 2
...
# 4 "../Xilinx_Prj/SoC-based-MatMul-Accelerator-and-DNN-Accelerator/letnet_hls/letnet_conv1_hls.cpp" 2

__attribute__((sdx_kernel("convolution1_hls", 0))) void convolution1_hls(
    float input[1][32][32],
    float weights[6][1][5][5],
    float bias[6],
    float output[6][28][28]
) {
#line 14 "E:/Vitis/lenet_conv1/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=convolution1_hls
# 10 "../Xilinx_Prj/SoC-based-MatMul-Accelerator-and-DNN-Accelerator/letnet_hls/letnet_conv1_hls.cpp"
...
#pragma HLS INTERFACE m_axi depth=1680 port=output offset=slave bundle=OUTPUT
 ...
 VITIS_LOOP_18_1: for (int co = 0; co < 6; co++) {
#pragma HLS UNROLL factor=2


 VITIS_LOOP_22_2: for (int h = 0; h < 28; h++) {
#pragma HLS PIPELINE II=1


 VITIS_LOOP_26_3: for (int w = 0; w < 28; w++) {
                float sum = 0.0f;


                VITIS_LOOP_30_4: for (int kh = 0; kh < 5; kh++) {
                    VITIS_LOOP_31_5: for (int kw = 0; kw < 5; kw++) {
