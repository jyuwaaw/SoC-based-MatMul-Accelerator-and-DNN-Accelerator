...
entity convolution1_hls_convolution1_hls_Pipeline_VITIS_LOOP_18_1_VITIS_LOOP_19_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of convolution1_hls_convolution1_hls_Pipeline_VITIS_LOOP_18_1_VITIS_LOOP_19_2 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln18_fu_118_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal INPUT_r_addr_read_reg_252 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln21_1_fu_197_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal j_fu_60 : STD_LOGIC_VECTOR (5 downto 0) := "000000";
    signal add_ln19_fu_206_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal i_fu_64 : STD_LOGIC_VECTOR (5 downto 0) := "000000";
    signal select_ln18_1_fu_167_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal indvar_flatten_fu_68 : STD_LOGIC_VECTOR (10 downto 0) := "00000000000";
    signal add_ln18_1_fu_124_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_sig_allocacmp_indvar_flatten_load : STD_LOGIC_VECTOR (10 downto 0);
    signal icmp_ln19_fu_153_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln18_fu_147_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal trunc_ln21_fu_175_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal select_ln18_fu_159_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_1_fu_179_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal zext_ln21_fu_187_p1 : STD_LOGIC_VECTOR (9 downto 0);
    signal add_ln21_fu_191_p2 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln18_fu_118_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    INPUT_r_blk_n_R_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, m_axi_INPUT_r_RVALID, ap_block_pp0_stage0)
    begin
    ...
    add_ln18_1_fu_124_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten_load) + unsigned(ap_const_lv11_1));
    add_ln18_fu_147_p2 <= std_logic_vector(unsigned(i_fu_64) + unsigned(ap_const_lv6_1));
    add_ln19_fu_206_p2 <= std_logic_vector(unsigned(select_ln18_fu_159_p3) + unsigned(ap_const_lv6_1));
    add_ln21_fu_191_p2 <= std_logic_vector(unsigned(tmp_1_fu_179_p3) + unsigned(zext_ln21_fu_187_p1));
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(m_axi_INPUT_r_RVALID)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (m_axi_INPUT_r_RVALID = ap_const_logic_0);
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln18_fu_118_p2)
    begin
        if (((icmp_ln18_fu_118_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln18_fu_118_p2 <= "1" when (ap_sig_allocacmp_indvar_flatten_load = ap_const_lv11_400) else "0";
    icmp_ln19_fu_153_p2 <= "1" when (j_fu_60 = ap_const_lv6_20) else "0";
    local_input_address0 <= zext_ln21_1_fu_197_p1(10 - 1 downto 0);
    ...
    local_input_d0 <= INPUT_r_addr_read_reg_252;

    local_input_we0_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    m_axi_INPUT_r_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
    ...
    select_ln18_1_fu_167_p3 <= 
        add_ln18_fu_147_p2 when (icmp_ln19_fu_153_p2(0) = '1') else 
        i_fu_64;
    select_ln18_fu_159_p3 <= 
        ap_const_lv6_0 when (icmp_ln19_fu_153_p2(0) = '1') else 
        j_fu_60;
    tmp_1_fu_179_p3 <= (trunc_ln21_fu_175_p1 & ap_const_lv5_0);
    trunc_ln21_fu_175_p1 <= select_ln18_1_fu_167_p3(5 - 1 downto 0);
    zext_ln21_1_fu_197_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln21_fu_191_p2),64));
    zext_ln21_fu_187_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln18_fu_159_p3),10));
end behav;
