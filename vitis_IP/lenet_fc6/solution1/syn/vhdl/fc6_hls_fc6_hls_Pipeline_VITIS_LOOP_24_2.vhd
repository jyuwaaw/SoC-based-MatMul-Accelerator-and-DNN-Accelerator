...
entity fc6_hls_fc6_hls_Pipeline_VITIS_LOOP_24_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fc6_hls_fc6_hls_Pipeline_VITIS_LOOP_24_2 is 
...
attribute shreg_extract : string;
    ...
    signal c_fu_64 : STD_LOGIC_VECTOR (6 downto 0) := "0000000";
    signal add_ln24_fu_132_p2 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    component fc6_hls_flow_control_loop_pipe_sequential_init IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    flow_control_loop_pipe_sequential_init_U : component fc6_hls_flow_control_loop_pipe_sequential_init
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => ap_start,
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln24_fu_126_p2 = ap_const_lv1_0))) then 
                    c_fu_64 <= add_ln24_fu_132_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    c_fu_64 <= ap_const_lv7_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage1_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1))) then
                ...
                mul_reg_225 <= grp_fu_681_p_dout0;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln24_fu_132_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_c_2) + unsigned(ap_const_lv7_1));
    ...
    ap_sig_allocacmp_c_2_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_loop_init, c_fu_64, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_c_2 <= ap_const_lv7_0;
        else 
            ap_sig_allocacmp_c_2 <= c_fu_64;
        end if; 
    end process;


    ap_sig_allocacmp_sum_load_assign_proc : process(ap_enable_reg_pp0_iter2, ap_CS_fsm_pp0_stage2, sum_fu_60, ap_block_pp0_stage2, grp_fu_263_p_dout0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage2) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage2))) then 
            ap_sig_allocacmp_sum_load <= grp_fu_263_p_dout0;
        else 
            ap_sig_allocacmp_sum_load <= sum_fu_60;
        end if; 
    end process;
    ...
    grp_fu_263_p_ce <= grp_fu_97_ce;
    grp_fu_263_p_din0 <= ap_sig_allocacmp_sum_load;
    grp_fu_263_p_din1 <= mul_reg_225;
    grp_fu_263_p_opcode <= ap_const_lv2_0;
    grp_fu_681_p_ce <= grp_fu_101_ce;
    grp_fu_681_p_din0 <= input_val_fu_155_p1;
    grp_fu_681_p_din1 <= weight_val_fu_159_p1;
    ...
    icmp_ln24_fu_126_p2 <= "1" when (ap_sig_allocacmp_c_2 = ap_const_lv7_78) else "0";
    ...
    sum_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage2, icmp_ln24_reg_201_pp0_iter1_reg, ap_block_pp0_stage2_11001)
    begin
