...
module fc6_hls_fc6_hls_Pipeline_VITIS_LOOP_24_21 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
fc6_hls_flow_control_loop_pipe_sequential_init flow_control_loop_pipe_sequential_init_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(ap_start),
    .ap_ready(ap_ready),
...
assign add_ln24_fu_132_p2 = (ap_sig_allocacmp_c_1 + 7'd1);
...
assign grp_fu_263_p_ce = grp_fu_97_ce;

assign grp_fu_263_p_din0 = ap_sig_allocacmp_sum_load_1;

assign grp_fu_263_p_din1 = mul_1_reg_225;

assign grp_fu_263_p_opcode = 2'd0;

assign grp_fu_681_p_ce = grp_fu_101_ce;

assign grp_fu_681_p_din0 = input_val_fu_155_p1;

assign grp_fu_681_p_din1 = weight_val_fu_159_p1;

assign icmp_ln24_fu_126_p2 = ((ap_sig_allocacmp_c_1 == 7'd120) ? 1'b1 : 1'b0);
...
assign sum_2_out = sum_fu_60;

assign weight_val_fu_159_p1 = WEIGHTS_addr_read_reg_210;

endmodule //fc6_hls_fc6_hls_Pipeline_VITIS_LOOP_24_21
