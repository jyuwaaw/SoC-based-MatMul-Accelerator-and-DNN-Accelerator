...
using hls::sim::Byte;
extern "C" void fc6_hls(Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, int, int, int, int);
extern "C" void apatb_fc6_hls_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_weights, volatile void * __xlx_apatb_param_bias, volatile void * __xlx_apatb_param_output_r) {
...
__xlx_weights__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_weights)[i]);
  ...
  int __xlx_size_param_weights = 1200;
...
__xlx_output_r__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_output_r)[i]);
  ...
  // DUT call
  fc6_hls(__xlx_input_r__tmp_vec.data(), __xlx_weights__tmp_vec.data(), __xlx_bias__tmp_vec.data(), __xlx_output_r__tmp_vec.data(), __xlx_offset_byte_param_input_r, __xlx_offset_byte_param_weights, __xlx_offset_byte_param_bias, __xlx_offset_byte_param_output_r);
