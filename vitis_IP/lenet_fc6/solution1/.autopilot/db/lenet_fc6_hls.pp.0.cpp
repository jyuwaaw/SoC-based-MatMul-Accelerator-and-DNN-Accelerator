# 1 "../SoC-based-MatMul-Accelerator-and-DNN-Accelerator/lenet_hls/lenet_fc6_hls.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../SoC-based-MatMul-Accelerator-and-DNN-Accelerator/lenet_hls/lenet_fc6_hls.cpp" 2
...
# 3 "../SoC-based-MatMul-Accelerator-and-DNN-Accelerator/lenet_hls/lenet_fc6_hls.cpp" 2
...
# 4 "../SoC-based-MatMul-Accelerator-and-DNN-Accelerator/lenet_hls/lenet_fc6_hls.cpp" 2

__attribute__((sdx_kernel("fc6_hls", 0))) void fc6_hls(
    float input[120][1][1],
    float weights[10][120][1][1],
    float bias[10],
    float output[10]
) {
#line 14 "E:/Vitis/lenet_fc6/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=fc6_hls
# 10 "../SoC-based-MatMul-Accelerator-and-DNN-Accelerator/lenet_hls/lenet_fc6_hls.cpp"
...
#pragma HLS INTERFACE m_axi depth=10 port=output offset=slave bundle=OUTPUT
 ...
 VITIS_LOOP_18_1: for (int n = 0; n < 10; n++) {
#pragma HLS UNROLL factor=2

 float sum = 0.0f;


        VITIS_LOOP_24_2: for (int c = 0; c < 120; c++) {
