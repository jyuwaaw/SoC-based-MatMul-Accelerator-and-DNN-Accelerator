...
entity convolution3_hls_convolution3_hls_Pipeline_VITIS_LOOP_46_8 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of convolution3_hls_convolution3_hls_Pipeline_VITIS_LOOP_46_8 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln46_fu_88_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal co_1_reg_131 : STD_LOGIC_VECTOR (4 downto 0);
    signal co_1_reg_131_pp0_iter1_reg : STD_LOGIC_VECTOR (4 downto 0);
    signal BIAS_addr_read_reg_140 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln46_fu_111_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal co_fu_48 : STD_LOGIC_VECTOR (4 downto 0) := "00000";
    signal add_ln46_fu_94_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_co_1 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    ...
    co_fu_48_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln46_fu_88_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    co_fu_48 <= add_ln46_fu_94_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    co_fu_48 <= ap_const_lv5_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    add_ln46_fu_94_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_co_1) + unsigned(ap_const_lv5_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln46_fu_88_p2)
    begin
        if (((icmp_ln46_fu_88_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_co_1_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, co_fu_48, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_co_1 <= ap_const_lv5_0;
        else 
            ap_sig_allocacmp_co_1 <= co_fu_48;
        end if; 
    end process;

    icmp_ln46_fu_88_p2 <= "1" when (ap_sig_allocacmp_co_1 = ap_const_lv5_10) else "0";
    local_bias_address0 <= zext_ln46_fu_111_p1(4 - 1 downto 0);
    ...
    local_bias_d0 <= BIAS_addr_read_reg_140;
    ...
    zext_ln46_fu_111_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(co_1_reg_131_pp0_iter1_reg),64));
end behav;
