...
set Library     "hls"
set IPName      "convolution3_hls"
set Version     "1.0"
set DisplayName "Convolution3_hls"
set Revision    "0"
...
set xo_kernel_name "convolution3_hls"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "E:/Vitis/lenet_conv3/solution1"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "E:/Vitis/lenet_conv3/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {convolution3_hls_flow_control_loop_pipe_sequential_init
convolution3_hls_flow_control_loop_pipe_sequential_init
convolution3_hls_flow_control_loop_pipe_sequential_init
...
set kernel_xo ""
set detect_deadlock_json "convolution3_hls_message_dict.json"

## Variables
set Top "convolution3_hls"
set TopNoPrefix "convolution3_hls"
...
set Interfaces {
    ...
    s_axi_control {
        ...
        registers {{0x10 input_r_r_1 W 0x0 "Data signal of input_r_r" {{0 32 input_r_r W 0 "Bit 31 to 0 of input_r_r"}}} {0x14 input_r_r_2 W 0x0 "Data signal of input_r_r" {{0 32 input_r_r W 0 "Bit 63 to 32 of input_r_r"}}} {0x1c weights_r_1 W 0x0 "Data signal of weights_r" {{0 32 weights_r W 0 "Bit 31 to 0 of weights_r"}}} {0x20 weights_r_2 W 0x0 "Data signal of weights_r" {{0 32 weights_r W 0 "Bit 63 to 32 of weights_r"}}} {0x28 bias_r_1 W 0x0 "Data signal of bias_r" {{0 32 bias_r W 0 "Bit 31 to 0 of bias_r"}}} {0x2c bias_r_2 W 0x0 "Data signal of bias_r" {{0 32 bias_r W 0 "Bit 63 to 32 of bias_r"}}} {0x34 output_r_r_1 W 0x0 "Data signal of output_r_r" {{0 32 output_r_r W 0 "Bit 31 to 0 of output_r_r"}}} {0x38 output_r_r_2 W 0x0 "Data signal of output_r_r" {{0 32 output_r_r W 0 "Bit 63 to 32 of output_r_r"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL_BUS s_axi_control m_axi_INPUT_r m_axi_WEIGHTS m_axi_BIAS m_axi_OUTPUT_r"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_BIAS {
        ...
        data_width "32"
        port_prefix "m_axi_BIAS"
        param_prefix "C_M_AXI_BIAS"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "0"
        offset_slave_name ""
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 722726 II x}
...
source -notrace "E:/Xilinx/Vitis_HLS/2023.2/common/scripts/ipxhls.tcl"
set outdir .
