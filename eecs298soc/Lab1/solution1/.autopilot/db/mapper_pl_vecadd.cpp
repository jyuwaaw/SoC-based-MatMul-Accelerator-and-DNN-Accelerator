...
using hls::sim::Byte;
extern "C" void pl_vecadd(Byte<4>*, Byte<4>*, Byte<4>*, int, int, int);
extern "C" void apatb_pl_vecadd_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_c) {
...
__xlx_c__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_c)[i]);
  ...
  // DUT call
  pl_vecadd(__xlx_a__tmp_vec.data(), __xlx_b__tmp_vec.data(), __xlx_c__tmp_vec.data(), __xlx_offset_byte_param_a, __xlx_offset_byte_param_b, __xlx_offset_byte_param_c);
