...
set Library     "hls"
set IPName      "pl_vecadd"
set Version     "1.0"
set DisplayName "Pl_vecadd"
set Revision    "0"
...
set xo_kernel_name "pl_vecadd"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/users/ugrad/yuhuah2/eecs298soc/Lab1/solution1"
set debug_dir "/users/ugrad/yuhuah2/eecs298soc/Lab1/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {pl_vecadd_fadd_32ns_32ns_32_4_full_dsp_1
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_ctrl m_axi_data0 m_axi_data1 m_axi_data2"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_data0 {
        ...
        data_width "32"
        port_prefix "m_axi_data0"
        param_prefix "C_M_AXI_DATA0"
    ...
    m_axi_data1 {
        ...
        data_width "32"
        port_prefix "m_axi_data1"
        param_prefix "C_M_AXI_DATA1"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_ctrl"
    ...
    m_axi_data2 {
        ...
        data_width "32"
        port_prefix "m_axi_data2"
        param_prefix "C_M_AXI_DATA2"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_ctrl"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 1045 II x}
