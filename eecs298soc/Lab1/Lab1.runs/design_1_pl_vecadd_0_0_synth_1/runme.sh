...
HD_PWD='/users/ugrad/yuhuah2/eecs298soc/Lab1/Lab1.runs/design_1_pl_vecadd_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_pl_vecadd_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_pl_vecadd_0_0.tcl
