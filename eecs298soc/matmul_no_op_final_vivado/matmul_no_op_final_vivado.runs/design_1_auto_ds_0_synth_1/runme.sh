...
HD_PWD='E:/Xilinx_Prj/SoC-based-MatMul-Accelerator-and-DNN-Accelerator/eecs298soc/matmul_no_op_final_vivado/matmul_no_op_final_vivado.runs/design_1_auto_ds_0_synth_1'
cd "$HD_PWD"
