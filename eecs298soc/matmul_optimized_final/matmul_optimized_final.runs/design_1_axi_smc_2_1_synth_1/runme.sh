...
HD_PWD='E:/Xilinx_Prj/SoC-based-MatMul-Accelerator-and-DNN-Accelerator/eecs298soc/matmul_optimized_final/matmul_optimized_final.runs/design_1_axi_smc_2_1_synth_1'
cd "$HD_PWD"
