...
-- Date        : Fri Dec 13 14:32:08 2024
-- Host        : Benji-ProArt running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub
--               e:/Xilinx_Prj/SoC-based-MatMul-Accelerator-and-DNN-Accelerator/eecs298soc/matmul_optimized_final/matmul_optimized_final.gen/sources_1/bd/design_1/ip/design_1_matmul_optimized_0_2/design_1_matmul_optimized_0_2_stub.vhdl
...
entity design_1_matmul_optimized_0_2 is
  Port ( 
    ...
    m_axi_dataOut_AWID : out STD_LOGIC_VECTOR ( 0 to 0 );
    m_axi_dataOut_AWADDR : out STD_LOGIC_VECTOR ( 63 downto 0 );
    m_axi_dataOut_AWLEN : out STD_LOGIC_VECTOR ( 7 downto 0 );
    m_axi_dataOut_AWSIZE : out STD_LOGIC_VECTOR ( 2 downto 0 );
    m_axi_dataOut_AWBURST : out STD_LOGIC_VECTOR ( 1 downto 0 );
    m_axi_dataOut_AWLOCK : out STD_LOGIC_VECTOR ( 1 downto 0 );
    m_axi_dataOut_AWREGION : out STD_LOGIC_VECTOR ( 3 downto 0 );
    m_axi_dataOut_AWCACHE : out STD_LOGIC_VECTOR ( 3 downto 0 );
    m_axi_dataOut_AWPROT : out STD_LOGIC_VECTOR ( 2 downto 0 );
    m_axi_dataOut_AWQOS : out STD_LOGIC_VECTOR ( 3 downto 0 );
    m_axi_dataOut_AWVALID : out STD_LOGIC;
    m_axi_dataOut_AWREADY : in STD_LOGIC;
    m_axi_dataOut_WID : out STD_LOGIC_VECTOR ( 0 to 0 );
    m_axi_dataOut_WDATA : out STD_LOGIC_VECTOR ( 31 downto 0 );
    m_axi_dataOut_WSTRB : out STD_LOGIC_VECTOR ( 3 downto 0 );
    m_axi_dataOut_WLAST : out STD_LOGIC;
    m_axi_dataOut_WVALID : out STD_LOGIC;
    m_axi_dataOut_WREADY : in STD_LOGIC;
    m_axi_dataOut_BID : in STD_LOGIC_VECTOR ( 0 to 0 );
    m_axi_dataOut_BRESP : in STD_LOGIC_VECTOR ( 1 downto 0 );
    m_axi_dataOut_BVALID : in STD_LOGIC;
    m_axi_dataOut_BREADY : out STD_LOGIC;
    m_axi_dataOut_ARID : out STD_LOGIC_VECTOR ( 0 to 0 );
    m_axi_dataOut_ARADDR : out STD_LOGIC_VECTOR ( 63 downto 0 );
    m_axi_dataOut_ARLEN : out STD_LOGIC_VECTOR ( 7 downto 0 );
    m_axi_dataOut_ARSIZE : out STD_LOGIC_VECTOR ( 2 downto 0 );
    m_axi_dataOut_ARBURST : out STD_LOGIC_VECTOR ( 1 downto 0 );
    m_axi_dataOut_ARLOCK : out STD_LOGIC_VECTOR ( 1 downto 0 );
    m_axi_dataOut_ARREGION : out STD_LOGIC_VECTOR ( 3 downto 0 );
    m_axi_dataOut_ARCACHE : out STD_LOGIC_VECTOR ( 3 downto 0 );
    m_axi_dataOut_ARPROT : out STD_LOGIC_VECTOR ( 2 downto 0 );
    m_axi_dataOut_ARQOS : out STD_LOGIC_VECTOR ( 3 downto 0 );
    m_axi_dataOut_ARVALID : out STD_LOGIC;
    m_axi_dataOut_ARREADY : in STD_LOGIC;
    m_axi_dataOut_RID : in STD_LOGIC_VECTOR ( 0 to 0 );
    m_axi_dataOut_RDATA : in STD_LOGIC_VECTOR ( 31 downto 0 );
    m_axi_dataOut_RRESP : in STD_LOGIC_VECTOR ( 1 downto 0 );
    m_axi_dataOut_RLAST : in STD_LOGIC;
    m_axi_dataOut_RVALID : in STD_LOGIC;
    m_axi_dataOut_RREADY : out STD_LOGIC
  );

end design_1_matmul_optimized_0_2;

architecture stub of design_1_matmul_optimized_0_2 is
