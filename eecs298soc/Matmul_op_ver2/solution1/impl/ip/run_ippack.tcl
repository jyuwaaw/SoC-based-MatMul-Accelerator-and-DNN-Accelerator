...
set Library     "hls"
set IPName      "matmul_optimized"
set Version     "1.0"
set DisplayName "Matmul_optimized"
set Revision    "0"
...
set xo_kernel_name "matmul_optimized"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/users/ugrad/yuhuah2/eecs298soc/Matmul_op_ver2/solution1"
set debug_dir "/users/ugrad/yuhuah2/eecs298soc/Matmul_op_ver2/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {matmul_optimized_flow_control_loop_pipe_sequential_init
...
## Variables
set Top "matmul_optimized"
set TopNoPrefix "matmul_optimized"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_ctrl m_axi_dataA m_axi_dataB m_axi_dataAB"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_dataA {
        ...
        data_width "32"
        port_prefix "m_axi_dataA"
        param_prefix "C_M_AXI_DATAA"
    ...
    m_axi_dataB {
        ...
        data_width "32"
        port_prefix "m_axi_dataB"
        param_prefix "C_M_AXI_DATAB"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_ctrl"
    ...
    m_axi_dataAB {
        ...
        data_width "32"
        port_prefix "m_axi_dataAB"
        param_prefix "C_M_AXI_DATAAB"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        HasOffset "1"
        has_dependant_on "1"
        offset_slave_name "s_axi_ctrl"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 862 II x}
...
source -notrace "/ecelib/eceware/xilinx_2023.1/Vitis_HLS/2023.1/common/scripts/ipxhls.tcl"
