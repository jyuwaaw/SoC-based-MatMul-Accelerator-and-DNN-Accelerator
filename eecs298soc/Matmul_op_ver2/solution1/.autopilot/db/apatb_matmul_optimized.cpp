...
// wrapc file define:
#define AUTOTB_TVIN_A "../tv/cdatafile/c.matmul_optimized.autotvin_A.dat"
#define AUTOTB_TVOUT_A "../tv/cdatafile/c.matmul_optimized.autotvout_A.dat"
#define AUTOTB_TVIN_B "../tv/cdatafile/c.matmul_optimized.autotvin_B.dat"
#define AUTOTB_TVOUT_B "../tv/cdatafile/c.matmul_optimized.autotvout_B.dat"
#define AUTOTB_TVIN_AB "../tv/cdatafile/c.matmul_optimized.autotvin_AB.dat"
#define AUTOTB_TVOUT_AB "../tv/cdatafile/c.matmul_optimized.autotvout_AB.dat"
#define AUTOTB_TVIN_dataA "../tv/cdatafile/c.matmul_optimized.autotvin_dataA.dat"
#define AUTOTB_TVOUT_dataA "../tv/cdatafile/c.matmul_optimized.autotvout_dataA.dat"
#define AUTOTB_TVIN_dataAB "../tv/cdatafile/c.matmul_optimized.autotvin_dataAB.dat"
#define AUTOTB_TVOUT_dataAB "../tv/cdatafile/c.matmul_optimized.autotvout_dataAB.dat"
#define AUTOTB_TVIN_dataB "../tv/cdatafile/c.matmul_optimized.autotvin_dataB.dat"
#define AUTOTB_TVOUT_dataB "../tv/cdatafile/c.matmul_optimized.autotvout_dataB.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_dataA "../tv/rtldatafile/rtl.matmul_optimized.autotvout_dataA.dat"
#define AUTOTB_TVOUT_PC_dataAB "../tv/rtldatafile/rtl.matmul_optimized.autotvout_dataAB.dat"
#define AUTOTB_TVOUT_PC_dataB "../tv/rtldatafile/rtl.matmul_optimized.autotvout_dataB.dat"
...
extern "C"
void matmul_optimized_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_matmul_optimized_hw(void* __xlx_apatb_param_A, void* __xlx_apatb_param_B, void* __xlx_apatb_param_AB)
{
  ...
  hls::sim::Byte<4> __xlx_offset_byte_param_AB;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_AB),
#endif
  };
  port2.param = &__xlx_offset_byte_param_AB;
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port3 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_dataA),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_dataA),
#endif
#endif
  };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_dataAB),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_dataAB),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_dataAB),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_dataAB),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_dataAB),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_dataAB),
#endif
#endif
  };
  port4.param = { __xlx_apatb_param_AB };
  port4.nbytes = { 1024 };
  port4.offset = {  };
  port4.hasWrite = { true };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port5 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_dataB),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_dataB),
#endif
#endif
  };
  ...
  try {
    ...
    matmul_optimized_hw_stub_wrapper(__xlx_apatb_param_A, __xlx_apatb_param_B, __xlx_apatb_param_AB);
