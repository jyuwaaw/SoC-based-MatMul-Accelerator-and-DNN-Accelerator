; ModuleID = '/users/ugrad/yuhuah2/eecs298soc/Matmul_op_ver2/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline
define void @apatb_matmul_optimized_ir([16 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="16" "maxi" %A, [16 x float]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="16" "maxi" %B, [16 x float]* noalias nocapture nonnull "fpga.decayed.dim.hint"="16" "maxi" %AB) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_matmul_optimized_hw([16 x [16 x float]]* %A_copy, [16 x [16 x float]]* %B_copy, [16 x [16 x float]]* %AB_copy)
...
declare void @apatb_matmul_optimized_hw([16 x [16 x float]]*, [16 x [16 x float]]*, [16 x [16 x float]]*)
...
define void @matmul_optimized_hw_stub_wrapper([16 x [16 x float]]*, [16 x [16 x float]]*, [16 x [16 x float]]*) #5 {
entry:
  ...
  call void @matmul_optimized_hw_stub([16 x float]* %3, [16 x float]* %4, [16 x float]* %5)
...
declare void @matmul_optimized_hw_stub([16 x float]*, [16 x float]*, [16 x float]*)
