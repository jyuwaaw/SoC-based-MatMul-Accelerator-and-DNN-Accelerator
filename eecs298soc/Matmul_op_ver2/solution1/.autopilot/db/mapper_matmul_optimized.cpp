...
using hls::sim::Byte;
extern "C" void matmul_optimized(Byte<4>*, Byte<4>*, Byte<4>*, int, int, int);
extern "C" void apatb_matmul_optimized_hw(volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B, volatile void * __xlx_apatb_param_AB) {
...
__xlx_B__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_B)[i]);
  ...
  // Collect __xlx_AB__tmp_vec
std::vector<Byte<4>> __xlx_AB__tmp_vec;
for (size_t i = 0; i < 256; ++i){
__xlx_AB__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_AB)[i]);
}
  int __xlx_size_param_AB = 256;
  int __xlx_offset_param_AB = 0;
  int __xlx_offset_byte_param_AB = 0*4;
  // DUT call
  matmul_optimized(__xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data(), __xlx_AB__tmp_vec.data(), __xlx_offset_byte_param_A, __xlx_offset_byte_param_B, __xlx_offset_byte_param_AB);
...
// print __xlx_apatb_param_AB
for (size_t i = 0; i < __xlx_size_param_AB; ++i) {
((Byte<4>*)__xlx_apatb_param_AB)[i] = __xlx_AB__tmp_vec[__xlx_offset_param_AB+i];
}
}
