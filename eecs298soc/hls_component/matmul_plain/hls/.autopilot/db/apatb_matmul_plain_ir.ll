; ModuleID = 'E:/Xilinx_Prj/SoC-based-MatMul-Accelerator-and-DNN-Accelerator/eecs298soc/hls_component/matmul_plain/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
declare void @matmul_plain_hw_stub([16 x float]* noalias nocapture nonnull readonly, [16 x float]* noalias nocapture nonnull readonly, [16 x float]* noalias nocapture nonnull)
