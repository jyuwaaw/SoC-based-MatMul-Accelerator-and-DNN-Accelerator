...
namespace eval ::optrace {
  variable script "/users/ugrad/yuhuah2/eecs298soc/Matmul_no_op_1/Matmul_no_op_1.runs/impl_1/design_1_wrapper.tcl"
...
set rc [catch {
  ...
  set_param runs.launchOptions { -jobs 56  }
...
OPTRACE "add files" START { }
  add_files -quiet /users/ugrad/yuhuah2/eecs298soc/Matmul_no_op_1/Matmul_no_op_1.runs/synth_1/design_1_wrapper.dcp
