...
HD_PWD='/users/ugrad/yuhuah2/eecs298soc/Matmul_no_op_1/Matmul_no_op_1.runs/design_1_matmul_plain_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_matmul_plain_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_matmul_plain_0_0.tcl
