...
using hls::sim::Byte;
extern "C" void matmul_plain(Byte<4>*, Byte<4>*, Byte<4>*, int, int, int);
extern "C" void apatb_matmul_plain_hw(volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B, volatile void * __xlx_apatb_param_AB) {
...
__xlx_AB__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_AB)[i]);
  ...
  // DUT call
  matmul_plain(__xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data(), __xlx_AB__tmp_vec.data(), __xlx_offset_byte_param_A, __xlx_offset_byte_param_B, __xlx_offset_byte_param_AB);
